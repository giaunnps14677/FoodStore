...
public class ImageFoodRestController {
	...
	@GetMapping(value = "/findImageFoodByFoodId/{id}")
	public List<ImageFood> findImageFoodByFoodId(@PathVariable("id") Long foodId){
		return imageFoodService.findImageFoodByFoodId(foodId);
	}
